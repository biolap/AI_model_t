...
class EmotionalRangeModel:
    def __init__(self, emotional_state):
        ...
        self.emotions = {
            "joy": ctrl.Consequent(np.arange(0, 1.1, 0.1), 'joy_intensity'),
            "sadness": ctrl.Consequent(np.arange(0, 1.1, 0.1), 'sadness_intensity'),
            "anger": ctrl.Consequent(np.arange(0, 1.1, 0.1), 'anger_intensity'),
            "fear": ctrl.Consequent(np.arange(0, 1.1, 0.1), 'fear_intensity'),
            "surprise": ctrl.Consequent(np.arange(0, 1.1, 0.1), 'surprise_intensity')
        }
        ...
        for emotion_intensity in self.emotions.values():
        ...
        self.rules = {
            "joy": [
                ctrl.Rule(self.stimulus_intensity['high'] & self.stimulus_valence['positive'], self.emotions['joy']['high']),
                ctrl.Rule(self.stimulus_intensity['medium'] & self.stimulus_valence['positive'], self.emotions['joy']['medium']),
                ctrl.Rule(self.stimulus_intensity['low'] & self.stimulus_valence['positive'], self.emotions['joy']['low'])
            ],
            "sadness": [
                ctrl.Rule(self.stimulus_intensity['high'] & self.stimulus_valence['negative'], self.emotions['sadness']['high']),
                ctrl.Rule(self.stimulus_intensity['medium'] & self.stimulus_valence['negative'], self.emotions['sadness']['medium']),
                ctrl.Rule(self.stimulus_intensity['low'] & self.stimulus_valence['negative'], self.emotions['sadness']['low'])
            ],
            "anger": [
                ctrl.Rule(self.stimulus_intensity['high'] & self.stimulus_valence['negative'], self.emotions['anger']['high']),
                ctrl.Rule(self.stimulus_intensity['medium'] & self.stimulus_valence['negative'], self.emotions['anger']['medium']),
                ctrl.Rule(self.stimulus_intensity['low'] & self.stimulus_valence['negative'], self.emotions['anger']['low'])
            ],
            "fear": [
                ctrl.Rule(self.stimulus_intensity['high'] & self.stimulus_valence['negative'], self.emotions['fear']['high']),
                ctrl.Rule(self.stimulus_intensity['medium'] & self.stimulus_valence['negative'], self.emotions['fear']['medium']),
                ctrl.Rule(self.stimulus_intensity['low'] & self.stimulus_valence['negative'], self.emotions['fear']['low'])
            ],
            "surprise": [
                ctrl.Rule(self.stimulus_intensity['high'] & self.stimulus_valence['neutral'], self.emotions['surprise']['high']),
                ctrl.Rule(self.stimulus_intensity['medium'] & self.stimulus_valence['neutral'], self.emotions['surprise']['medium']),
                ctrl.Rule(self.stimulus_intensity['low'] & self.stimulus_valence['neutral'], self.emotions['surprise']['low'])
            ]
        }
    ...
    def get_emotion_intensity(self, emotion, stimulus_intensity, stimulus_valence):
        ...
        simulation = self.simulations[emotion]  # !!!  Исправлено
        simulation.input['stimulus_intensity'] = stimulus_intensity
        simulation.input['stimulus_valence'] = stimulus_valence

        simulation.output[f'{emotion}_intensity'] = 0.0  # Добавляем выходную переменную
        simulation.compute()

        intensity = simulation.output[f'{emotion}_intensity']
        self.emotional_state.set_emotion_intensity(list(self.emotions.keys()).index(emotion), intensity)
        return intensity
